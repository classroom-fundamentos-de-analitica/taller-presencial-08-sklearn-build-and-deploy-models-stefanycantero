...
# Invoke-WebRequest -Uri http://127.0.0.1:5000 -Method POST -ContentType "application/json" -Body '{"bathrooms": "2", "bedrooms": "3", "sqft_living": "1800", "sqft_lot": "2200", "floors": "1", "waterfront": "1", "condition": "3"}'
#
